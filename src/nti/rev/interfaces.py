...
# Completed and Cancelled are the only status values guaranteed not to change in v1 of the API.
...
ORDER_STATUS_VOCABULARY = vocabulary.SimpleVocabulary([vocabulary.SimpleTerm(_x) for _x in ORDER_STATUS_ITEMS])
...
SUBTITLE_LANGUAGE_VOCABULARY = vocabulary.SimpleVocabulary([vocabulary.SimpleTerm(_x) for _x in SUBTITLE_LANGUAGE_ITEMS])
...
OUTPUT_FILE_FORMAT_VOCABULARY = vocabulary.SimpleVocabulary([vocabulary.SimpleTerm(_x) for _x in OUTPUT_FILE_FORMAT_ITEMS])
...
NOTIFICATION_VOCABULARY = vocabulary.SimpleVocabulary([vocabulary.SimpleTerm(_x) for _x in NOTIFICATION_ITEMS])
...
ATTACHMENT_KIND_VOCABULARY = vocabulary.SimpleVocabulary([vocabulary.SimpleTerm(_x) for _x in ATTACHMENT_KIND_ITEMS])
...
MONOLOGUE_ELEMENT_TYPE_VOCABULARY = vocabulary.SimpleVocabulary([vocabulary.SimpleTerm(_x) for _x in MONOLOGUE_ELEMENT_TYPE_ITEMS])
...
class IMonologueElement(interface.Interface):
    ...
    """
    # FIXME: schema?
    # FIXME: Indicate required for tag elements but not required for text elements
